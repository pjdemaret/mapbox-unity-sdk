...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Physically Based/Cutout/2 Sided/Diffuse (Fixed)"
{
	Properties
	{
		//Tag         
		...
		//Rendering Options
		[V_WIRE_RenderingOptions_Geometry] _V_WIRE_RenderingOptions_PBREnumID("", float) = 0
...
#include "../cginc/Wireframe_GS.cginc"
	...
	//Shadow
	UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Shadow/Cutout/Full/SHADOWCASTER"
