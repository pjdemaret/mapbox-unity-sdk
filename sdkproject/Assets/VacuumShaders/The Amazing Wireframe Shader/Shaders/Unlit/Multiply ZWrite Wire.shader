...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/Unlit/Multiply/ZWrite/Wire Only"
{
    Properties 
    {
		//Tag 
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/Unlit/Multiply/Simple/Wire Only/BASE"
