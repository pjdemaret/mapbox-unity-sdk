...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/Unlit/Addative/ZWrite/Full"
{
    Properties 
    {
		//Tag 
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/Unlit/Addative/Simple/Full/BASE"
